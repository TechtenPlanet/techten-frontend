...
export const CAREER_PROGRAMME_DB_ID = process.env.NOTION_CAREER_PROGRAMME_DB_ID;
...
export const HERO_SLIDES_DB_ID = process.env.NOTION_HERO_SLIDES_DATABASE_ID;
